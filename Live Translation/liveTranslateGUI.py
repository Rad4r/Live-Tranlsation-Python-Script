...
DutchButton = tk.Button(root, text="Dutch", command = partial(SetNewLang, "Dutch", "nl"))
GermanButton = tk.Button(root, text="German", command = partial(SetNewLang,"German","de"))
ChineseButton = tk.Button(root, text="Chinese", command = partial(SetNewLang,"Chinese","zh-cn"))
FrenchButton = tk.Button(root, text="French", command = partial(SetNewLang,"French","fr"))
